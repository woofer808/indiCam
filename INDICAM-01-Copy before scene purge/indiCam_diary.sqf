...
indiCam_diaryControls = player createDiaryRecord ["indiCam", ["Controls", 
	...
	<br/>
	<execute expression='[false] spawn indiCam_fnc_mapSelect;'>set friendly actor on map</execute><br/>
	<br/>
	<execute expression='[true] spawn indiCam_fnc_mapSelect;'>set ANY actor on map</execute><br/>
	<br/>
	<br/>
