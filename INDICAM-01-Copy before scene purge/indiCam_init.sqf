...
//TODO- Check if [] spawn indiCam_scene_mainScripted; needs to be checked for completion as with execVM in indiCam_main
//TODO- Check if AT guy scripted scenes use actor as camera target. Should probably be indiCam_var_scriptedActor
//TODO- Make sure scripted scenes can't interrupt each other
//TODO- Still haven't gotten the gui to look right as a mod. It's also doesn't stretch well with screen resolution
...
//ADDED- Actor death should now take actor auto switch setting into account.
...
//FIXED- shakyChasePerson scene was broken causing severe jitter and is removed for now.
...
//FIXED- Drone cam scene for tanks was not defined.
...
//FIXED- When debug was on it spawned the logic spheres on every machine.
