...
// FIX- randomWideSmooth
// FIX- actorChase has a very similar view that is chosen at the zero action level
// FIX- droneCamPerson starts high, but comes down into a cheeseCam type view
// FIX- wheelCam: make it use logic cam commit
// FIX- hoodCamForward: make it use logic cam commit
// FIX- F2 seems to stop working at times
// FIX- 
...
//TODO- Handle aircraft altitudes again. I'll need a proper check to make sure I get the right altitude both above ground and water.
//TODO- Fill sceneSelector with scenes for all vicValues and actionValues
//TODO- Handle the situation of the actor being deleted or not existing in the first place
...
//TODO- Add a button that randomizes a new actor and preformes a smooth transition to the new actor
...
indiCam = 0;
indiCam_logicFollow = 0;
indiCam_logicInfront = 0;
indiCam_logicRotation = 0;
indiCam_logicCenterPoint = 0;
