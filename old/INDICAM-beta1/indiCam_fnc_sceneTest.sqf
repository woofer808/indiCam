...
_nextActorVisibleASL = lineIntersectsSurfaces [_nextCameraPos, eyePos actor, (vehicle player), (vehicle actor), true, -1];
...
_nextActorVisibleAGL = lineIntersectsSurfaces [(AGLToASL _nextCameraPos), eyePos actor, (vehicle player), (vehicle actor), true, -1];
// Convert list to boolean, true if actor is visible
