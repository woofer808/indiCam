...
private _barrelStart = (vehicle actor) selectionPosition "konec hlavne";
private _barrelEnd = (vehicle actor) selectionPosition "usti hlavne";  
_barrelStart = (vehicle actor) modelToWorldWorld _barrelStart; 
_barrelEnd = (vehicle actor) modelToWorldWorld _barrelEnd; 
